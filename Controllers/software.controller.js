...
async function triggerSoftwareEmail(softwareId, isUpdate) {
    ...
    const data = {
        ...
        setupCommand:       sw.setupCommand,
        envNotes:           sw.envNotes,
        deploymentNotes:    sw.deploymentNotes,
        credentialVaultUrl: sw.credentialVaultUrl,
        hostingLoginRef:    sw.hostingLoginRef,
        domainLoginRef:     sw.domainLoginRef,
        cloudConsoleRef:    sw.cloudConsoleRef,
        credentialNotes:    sw.credentialNotes,
        deploymentPlatform: sw.deploymentPlatform,
        deploymentBranch:   sw.deploymentBranch,
        deploymentUrl:      sw.deploymentUrl,
        buildStatus:        sw.buildStatus,
        lastDeployedAt:     sw.lastDeployedAt,
        price:              sw.price,
